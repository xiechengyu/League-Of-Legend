...
JHeroSkin = function() {
    ...
    // var charset ="utf-8";
    // setTimeout(function(){
    // loadScript("http://lol.qq.com/act/AutoCMS/publish/LOLWeb/heroSkin/heroSkinActV3.js?v=" + gets.ran, function() {
...
//                }
	...
	InitS7TeamScore : function(flag){
        ...
        if(flag==1){
			goUrl = "http://lpl.qq.com/web201612/data/LOL_MATCH2_GAME_95_1_GROUP_TEAM_SCORE_TOP.js";
            groups = ["A","B"];
		}
		// else{
		// 	goUrl = "http://lpl.qq.com/web201612/data/LOL_MATCH2_GAME_58_19_GROUP_TEAM_SCORE_TOP.js";
		// 	groups = ["E","F","G","H"];
		// 	//alert("敬请期待");return;
		// }
		$.getScript(goUrl,function(){
...
/*  |xGv00|ea819dcbb4e3ae9a1e0dc4e8f68831bb */